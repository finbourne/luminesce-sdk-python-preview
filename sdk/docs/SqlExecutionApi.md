...
[**put_sql_to_writer_design**](SqlExecutionApi.md#put_sql_to_writer_design) | **PUT** /api/Sql/towriterdesign | [EXPERIMENTAL] PutSqlToWriterDesign: Generates a SQL-writer-design object from SQL string, if possible.
...
[**put_writer_design_to_sql**](SqlExecutionApi.md#put_writer_design_to_sql) | **PUT** /api/Sql/fromwriterdesign | [EXPERIMENTAL] PutWriterDesignToSql: Generates writer SQL from a valid writer-design structure
...
with luminesce.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling SqlExecutionApi->put_sql_to_writer_design: %s\n" % e)
```
...
with luminesce.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling SqlExecutionApi->put_writer_design_to_sql: %s\n" % e)
```
